// Generated by Wrangler by running `wrangler types` (hash: bc07d3c6e8ff767a62d23675c95ed8ab)
...
declare namespace Cloudflare {
	interface Env {
		...
		TG_SILENCE_CONSENSUS_POLL_USER_STATUS_CANNOT_SILENCE_ADMIN_TEMPLATE: "就畀你哋投吓票囉，ban唔到admin㗎 :0)";
		TG_SILENCE_CONSENSUS_POLL_TARGET_MESSAGE_IS_REMOVED: "個 message 已經鏟咗，開唔切 vote :0)";
		TG_SILENCE_CONSENSUS_POLL_UNKNOWN_ERROR: "炒咗粉喇，admin 睇 log 啦 :0)";
		TG_ADMIN_ONLY_COMMAND_TEXT: "叫 admin 幫你加 custom title 啦";
		...
		TG_ROSE_CAPTCHA_CLEANUP_ANNOUNCEMENT_TEMPLATE: "「{displayName}」驗證都唔撳，九成係騙子。已清理，世界線穩定。";
		TG_BOT_TOKEN: string;
