// Generated by Wrangler by running `wrangler types` (hash: 6fdfc905a7598c99691c32cf62ddcd9f)
...
declare namespace Cloudflare {
	interface Env {
		...
		TG_SILENCE_CONSENSUS_POLL_USER_STATUS_RESTRICTED_TEMPLATE: "被限制直至 {untilDate}";
		TG_BOT_TOKEN: string;
